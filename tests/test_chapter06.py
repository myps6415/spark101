...
from pyspark.ml.evaluation import (BinaryClassificationEvaluator,
                                   ...
                                   RegressionEvaluator)
# MLlib imports
from pyspark.ml.feature import (IDF, PCA, Bucketizer, HashingTF, MinMaxScaler,
                                OneHotEncoder, StandardScaler, StringIndexer,
...
class TestFeatureEngineering:
    ...
    def test_vector_assembler(self, spark_session):
        """測試向量組裝器"""
        # 創建測試數據
        data = [(1, 2.0, 3.0, 4.0), (2, 5.0, 6.0, 7.0), (3, 8.0, 9.0, 10.0)]
        df = spark_session.createDataFrame(
            data, ["id", "feature1", "feature2", "feature3"]
        )
    ...
    def test_one_hot_encoder(self, spark_session):
        """測試獨熱編碼"""
        # 創建測試數據
        data = [(1, 0.0), (2, 1.0), (3, 0.0), (4, 2.0), (5, 1.0)]
    ...
    def test_text_processing(self, spark_session):
        ...
        hashing_tf = HashingTF(
            inputCol="words", outputCol="raw_features", numFeatures=100
        )
...
class TestClassification:
    ...
    def test_random_forest_classifier(self, classification_data):
        ...
        rf = RandomForestClassifier(
            featuresCol="features", labelCol="label", numTrees=5, maxDepth=3
        )
...
class TestRegression:
    ...
    def test_random_forest_regressor(self, regression_data):
        ...
        rf = RandomForestRegressor(
            featuresCol="features", labelCol="label", numTrees=3, maxDepth=3
        )
...
class TestPipeline:
    ...
    def test_simple_pipeline(self, spark_session):
        ...
        df = spark_session.createDataFrame(
            data, ["id", "category", "feature1", "feature2", "label"]
        )

        # 建立管道
        indexer = StringIndexer(inputCol="category", outputCol="category_index")
        assembler = VectorAssembler(
            inputCols=["category_index", "feature1", "feature2"], outputCol="features"
        )
        lr = LogisticRegression(featuresCol="features", labelCol="label")
