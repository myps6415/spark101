...
def test_spark_session():
    ...
    try:
        ...
        os.environ["PYSPARK_SUBMIT_ARGS"] = (
            "--conf spark.hadoop.javax.jdo.option.ConnectionURL=jdbc:derby:memory:myInMemDB;create=true --conf spark.sql.catalogImplementation=in-memory pyspark-shell"
        )
        ...
        spark = (
            SparkSession.builder.appName("Spark101 Test")
            .master("local[1]")
...
def provide_setup_instructions():
    ...
    print(
        "   File > Settings > Project > Python Interpreter > Add > Poetry Environment"
    )
